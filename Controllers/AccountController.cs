...
public class AccountController : ControllerBase
{
        ...
        [FromServices] BlogDataContext context)
    {
        ...
        try
        {
            await System.IO.File.WriteAllBytesAsync($"wwwroot/imges/{fileName}", bytes);
        }
        catch (Exception ex) 
        {
            return StatusCode(500, new ResultViewModel<string>("05X04 - interna no servidor"));
        }
